        ...
        },
        {
          ...
          subMenus: [
            ...
            },
            {
              ...
              route: '',
              base: '',
              permision: 'eliminar_rol',
              show_nav: false,
            },
          ],
        },
        {
          menuValue: 'Optometras',
          hasSubRoute: true,
          showSubRoute: false,
          base: 'optometra',
          ...
          subMenus: [
            {
              menuValue: 'Listado Optometras',
              route: routes.doctorsList,
              base: routes.doctorsList,
              permision: 'listado_optometra',
              show_nav: true,
            },
            {
              menuValue: 'Regitrar Optometra',
              route: routes.addDoctor,
              base: routes.addDoctor,
              permision: 'registrar_optometra',
              show_nav: true,
            },
            {
              menuValue: 'Editar Optometra',
              route: '',
              base: '',
              permision: 'editar_optometra',
              show_nav: false,
            },
            {
              menuValue: 'Eliminar optometra',
              route: '',
              base: '',
              permision: 'eliminar_optometra',
              show_nav: false,
            },
            {
              menuValue: 'Perfil del Optometra',
              route: routes.doctorProfile,
              base: routes.doctorProfile,
              permision: 'perfil_optometra',
              show_nav: true,
            },
          ],
        },
        ...
        },
        {
          ...
          subMenus: [
            ...
            },
            {
              ...
              permision: 'registrar_usuario',
              show_nav: true,
            },
            {
              menuValue: 'Actualizar Informacion',
              route: '',
              base: '',
              permision: 'editar_usuario',
              show_nav: false,
            },
            {
              menuValue: 'Eliminar',
          ...
          subMenus: [
            {
              ...
              permision: 'listado_servicio,
              show_nav: true,
            },
            {
              menuValue: 'Add Serivicio',
              route: routes.addDepartment,
              base: routes.addDepartment,
              permision: 'registrar_servicio',
              show_nav: true,
            },
            {
              menuValue: 'Edit Serivicio',
              route: '',
              base: '',
              permision: 'editar_servicio',
              show_nav: false,
            },
            {
              menuValue: 'Eliminar Serivicio',
              route: '',
              base: '',
              permision: 'eliminar_servicio',
              show_nav: false,
            },
          ],
        },
        */
        {
          ...
          subMenus: [
            ...
            },
            {
              ...
              route: '',
              base: '',
              permision: 'editar_pago',
              show_nav: false,
            },
          ],
        },
        {
          menuValue: 'Actividades',
